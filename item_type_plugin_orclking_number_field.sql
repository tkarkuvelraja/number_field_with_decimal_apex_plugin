...
--   Date and Time:   19:16 Tuesday June 8, 2021
--   Exported By:     TKARKUVELRAJA@GMAIL.COM
--   Flashback:       0
--   Export Type:     Component Export
--   Manifest
--     PLUGIN: 11800558616951963878
--   Manifest End
--   Version:         21.1.0
...
/
prompt --application/shared_components/plugins/item_type/orclking_number_field
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(11800558616951963878)
,p_plugin_type=>'ITEM TYPE'
,p_name=>'ORCLKING.NUMBER.FIELD'
...
,p_help_text=>'This plugin allow only numeric value and only one dot in the number field'
,p_version_identifier=>'1.0'
,p_files_version=>35
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11773585840516836104)
,p_plugin_id=>wwv_flow_api.id(11800558616951963878)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11773608833371837338)
,p_plugin_attribute_id=>wwv_flow_api.id(11773585840516836104)
,p_display_sequence=>10
,p_display_value=>'Left'
,p_return_value=>'Left'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11773436874378838714)
,p_plugin_attribute_id=>wwv_flow_api.id(11773585840516836104)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11800565745155963888)
,p_plugin_id=>wwv_flow_api.id(11800558616951963878)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11800566142728963888)
,p_plugin_id=>wwv_flow_api.id(11800558616951963878)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(11768089495103743867)
,p_plugin_id=>wwv_flow_api.id(11800558616951963878)
